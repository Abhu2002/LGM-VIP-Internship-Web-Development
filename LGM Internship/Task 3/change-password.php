 ...
 <strong>Well done!</strong><?php echo htmlentities($msg); ?>
    ...
    <div class="alert alert-danger left-icon-alert" role="alert">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form  name="chngpwd" method="post" \ onSubmit="return valid();">
                                                    <div class="form-group has-success">
                                                        <label for="success" class="control-label"style="color:#0a0302;">Current Password</label>
                                                		<div class="">
                                    <input type="password" name="password" class="form-control" required="required" id="success">
                                                       ...
                                                       <div class="form-group has-success">
                                                        <label for="success" class="control-label"style="color:#0a0302;">New Password</label>
                                                        <div class="">
                                                            <input type="password" name="newpassword" required="required" class="form-control" id="success">
                                                        </div>
                                                    </div>
                                                     <div class="form-group has-success">
                                                        <label for="success" class="control-label"style="color:#0a0302;">Confirm Password</label>
                                                        <div class="">
